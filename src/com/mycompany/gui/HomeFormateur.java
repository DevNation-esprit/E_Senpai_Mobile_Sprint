 ...
 * @author Dahmani
 */
public class HomeFormateur extends Form{
    
    public HomeFormateur(User u, Resources res){
        setTitle("Accueil");
        ...
        if(u.getSexe().toLowerCase().equals("homme")){
            add(new Label("Bienvenue Mr."+u.getNom()+"  Id :"+u.getId()));
        }else{
            add(new Label("Bienvenue Mme."+u.getNom()+"  Id :"+u.getId()));
        }
